...
def setCredentials():
    ...
    Label(window,text='Set User ID: ', bg='white', fg='black').grid(row=0,column=0,sticky=E) 
    Label(window,text='Set Password: ', bg='white', fg='black').grid(row=1,column=0,sticky=E)  
    Label(window,text='Confirm Password: ', bg='white', fg='black').grid(row=2,column=0,sticky=E)  
